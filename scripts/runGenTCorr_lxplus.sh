...
OUT_DIR=/eos/user/c/cristova/WaterCherenkov/Trials_Framework_10epoch_minFeatures/MultiGaus_qt_corr_${1}
...
echo "COPYING OUTPUT"
mkdir -p ${OUT_DIR}
xrdcp -r ${local_dir}/CRinGe_MultiGaus_qt_corr_${1} ${OUT_DIR}

echo "DELETING LOCAL OUTPUT"
rm -rf ${local_dir}/CRinGe_MultiGaus_qt_corr_${1}
